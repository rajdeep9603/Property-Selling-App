...
//
//    final postPrefenceModel = postPrefenceModelFromJson(jsonString);
...
PostPreferenceModel postPrefenceModelFromJson(String str) =>
    PostPreferenceModel.fromJson(json.decode(str));

String postPrefenceModelToJson(PostPreferenceModel data) =>
    json.encode(data.toJson());

class PostPreferenceModel {
  PostPreferenceModel({
    this.status,
    this.errorCode,
    this.errorMsg,
  ...
  factory PostPreferenceModel.fromJson(Map<String, dynamic> json) =>
      PostPreferenceModel(
