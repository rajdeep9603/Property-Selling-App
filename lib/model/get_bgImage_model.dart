...
//
//     final bgImageModel = bgImageModelFromJson(jsonString);

import 'dart:convert';

BgImageModel bgImageModelFromJson(String str) =>
    BgImageModel.fromJson(json.decode(str));

String bgImageModelToJson(BgImageModel data) => json.encode(data.toJson());
